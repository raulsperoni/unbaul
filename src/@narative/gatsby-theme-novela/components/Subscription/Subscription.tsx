  ...
  return (
    <Section narrow>
      <SubscriptionContainer>
        <Content>
          <Heading>
            Si te gustó lo que leíste podés sumarte a la lista de correo
          </Heading>
          <Text>
            Vas a recibir los textos nuevos, nada de spam y podés darte de baja cuándo quieras.
          </Text>
          <Form onSubmit={handleSubmit} hasError={error}>
            ...
            <Button
              ...
              disabled={subscribed}
            >
              {subscribed ? <CheckMarkIcon /> : "Suscribirse"}
            </Button>
